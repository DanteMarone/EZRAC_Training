...
<html lang="en">
	...
	<head>
		...
		<style>
			body{
				background: url("http://intranet.ezrac.com/training/resources/swoop.png");
				background-size: 100%;
		...
		<div class="reveal">
			...
			<div class="slides">
				<section>
					...
					<h3>Manager Version</h3>
					
				</section>
				
				<section>
					<h2>Navigating This Presentation</h2>
					<p>Use the arrows on your keyboard to navigate left and right through the slides<br><img src="http://intranet.ezrac.com/training/resources/arrowsKeyboard.png"></p><br>
					<p class="fragment roll-in">You can also use the arrows in the bottom right to advance or replay slides</p>
				</section>
				
				<section style="background-color: #ffffff; color: #000000; font-size: .8em;">
					<div style="float: left;">
						<h2>Pretest</h2>
						<p style="font-size: .75em">Please tick true or false for each</p>
						<p>If a supervisor occasionally tells stories making fun of his parents unusual religious beliefs, but none of his co-workers or subordinates complains, you don't need to do anything about it?  <input type="checkbox">T or <input type="checkbox">F</p>
						<p>Quid Pro Quo sexual harassment occurs when a female boss tells dirty jokes to the men in the office.   <input type="checkbox">T or <input type="checkbox">F</p>
						<p>Sexual Harassment may be related to power on the job.  <input type="checkbox">T or <input type="checkbox">F</p>
						<p>Inappropriate conduct or actions are not considered sexual harassment if they are welcome by both parties <input type="checkbox">T or <input type="checkbox">F</p>
						<p>Diversity in the workplace is not important to E-Z's goals.   <input type="checkbox">T or <input type="checkbox">F</p>
					</div>
				</section>
				
				<!--Managers-->
				<section>
					<p> It is the policy of E-Z Rent-A-Car to ensure equal employment opportunity, prohibit discrimination in all forms, and promote diversity and inclusiveness in the workplace.</p>
					<br>
					
					<p> It is the policy of E-Z Rent-A-Car to enforce all federal EEO laws vigorously. </p>
						<br>
						<p> It is the responsibility of every manager and supervisor to ensure a workplace free from discrimination and harassment.</p>
				</section>
				...
				<h2> EEO</h2>
				<p>
				Set of laws and policies that mandates all individuals' rights to equal employment opportunity, irrespective of race, color, sex, sexual orientation, national origin, religion, age, disability or participation in EEO protected activity.</P>
				</section>
				
				<!--Managers-->
				<section>
					<h2>Managers will learn how to</h2>
					<li>Be aware of what affects their work group, including improper use of social media.</li>
					<li>Periodically conduct workplace audits looking for inappropriate items.</li>
					<li>Respond to complaints of inappropriate behavior.</li>
					<li>Conduct investigations or assist HR / Legal.</li>
					<li>Inform employees that retaliation will not be tolerated.</li>
				</section>
					
				
				<section>
					<p>A hostile work environment serves no good purpose and interferes with the E-Z Rent-a-Car's progress.</p>
					<br>
				...
				<section>
					...
					<br>
					<p style="float: right; background-color: #1c5ba8; border: 5px solid #ffffff;">The next <span style="text-decoration: underline; color: #ff0000; font-size: 1.5em;">COURT</span> case</p>

				</section>
				
				<section style="text-align: left">
					<h2>COURSE OBJECTIVES:</h2>
					<p>Realize the significance of E-Z Rent-A-Cars policies & the law.</p>
					<br>
				...
				<section>
					...
					<br><br>
					 <p>After this presentation, if you have any questions PLEASE — seek assistance from the company in reviewing the laws.	</p>
				</section>

				
				<section>
				<h2>Just WHAT type behavior is unacceptable in the workplace?</h2>
				...
				<section>
					<p>What is the most common type of harassment in today’s workplace?</p>
					<br>
					<h1 class="fragment roll-in"><img src="http://intranet.ezrac.com/training/resources/sexualHarassment.jpg" width="50%"><br>SEXUAL HARASSMENT</h1>

				</section>
				
				<section>
					<h2>TYPES OF HARASSMENT</h2>
					<img src="http://intranet.ezrac.com/training/resources/harassmentTypes.png" width="100%">
					<br>
				...
				<section>
					...
					<br>
					<p>Ongoing, pervasive, or severe behavior that unreasonably interferes with an individual's work performance or creates an intimidating, hostile, or offensive work environment.</p>
					<br>
					Example:
					<br>
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/slipperySlope.png">
				</section>
				...
				<section>
					<h2>Cyberharassment</h2>
					<p>As a manager, you must be vigilant about electronic forms of harassment.</p>
					<br>
					<p>It is your responsibility to promote a work environment where cyberharassment and bullying are not tolerated.</p>
					<br>
					<p>Encourage people to talk to each other rather than continuing the disagreement over email.  A face to face conversation will remove the emotional ambiguity of email or electronic communication.</p>
				</section>
				...
				<section>
					...
					<br>
					<p>While one single occurrence of harassment may not be considered illegal, it does violate E-Z Rent-A-Car's zero harassment policy.</p>
					<br>
					<p>Although a single unwanted request for a date or one sexually suggestive comment might offend you and or be inappropriate, it may not be sexual harassment.  However, a number of relatively minor separate incidents may add up to sexual harassment if the incidents affect your work environment.</p>
				</section>
				...
				<section>
					...
					<div class="floatLeft">
						...
						<li>How many others have been sexually harassed?</li>
						<li>Who were witnesses to the harassment?</li>
						</ul>
					</div>
					<div class="floatRight">
						<img src="http://intranet.ezrac.com/training/resources/sexualHarassment2.jpg">
					</div>
				</section>
				...
				<section style="font-size: .8em">
					...
					<p style="position: absolute; top: 80%; width: 100%;"><span class="fragment fade-out"><span style="font-size: 2em; color: #ff0000;">Q:</span> What if I reach a conclusion that what occurred was not illegal harassment?</span></p>
					<p class="fragment fade-in" style="position: absolute; top: 80%; width: 100%;"><span style="font-size: 2em; color: #ff0000;">A:</span> There are two likely reasons to reach a finding of no harassment:
					<br><br>
					A legitimate complaint of perceived harassment where a reasonable person would not have been offended underscores the reason for a full and fair investigation that gets both sides of the story. If it's based on mild behavor or a misunderstanding the complainant still needs to be protected from retaliation even though there has been a finding of no legal harassment or <br>E-Z Rent-A-Car's policy.
					<br><br>
					An "illegitimate" complaint where false information is knowingly provided by the complainant used to falsely accuse an employee of discrimination is a serious offence that often results in the most serious discipline.</p>
				</section>
				...
				<section>
					...
					<br>
					<br>
					<p>Harassment on the job by a non-employee <span style="text-decoration: underline">CAN</span> lead to harassment charges, just as harassment by an employee would.</p>
				</section>
				...
				<section>
					...
					<br><br>
					<img src="http://intranet.ezrac.com/training/resources/3rdParty.jpg"><br>
					Example:
					<br>
					A group of employees talking about each other’s sex lives in the presence of another person who feels very uncomfortable about such discussion.
				</section>
				...
				<section>
					<h2>Retaliation</h2>
					<p>Examples of retaliation as determined by the courts:</p>
					<ul style="margin-left: 15%; float: left;">
						<li>Terminating an employee
						<li>Changing job function or responsibilities
						<li>Demoting an employee
						<li>Moving an employee to a different department
						<li>Moving work assignments or other actions that result in a significant change in employee status
					</ul>
					<p style="clear: both;"><br>Even one ocurance of retaliation is considered illegal.  <br>E-Z Rent-A-Car does not tolerate retaliation.
				</section>
				
				<!--Managers-->
				<section >
					<h2>Reflection Questions</h2>
					<p style="position: absolute; top: 80%; width: 100%;"><span class="fragment fade-out"><span style="font-size: 2em; color: #ff0000;">Q:</span> What if I transfer the person out of my department to protect them from retaliation and further harassment?</span></p>
					<p class="fragment fade-in" style="position: absolute; top: 80%; width: 100%;"><span style="font-size: 2em; color: #ff0000;"> A:</span> Actually, once you're on notice of a problem, it's important to give your next step careful thought.  
					<br><br>
					Transferring the complainant or sending them home is usually not advised as it may be seen as retaliation.  Usually they just want to do their own job in their own workplace. 
					<br><br>
					It can be ok to ask victims for their input but in most cases it's best to remove the <span style="text-decoration: underline;">harasser</span> from the workgroup until the investigation is complete.  </p>
				</section>
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/colorHarassment.jpg">
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/faith.jpg" width="50%">
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/ageDiscrimination.jpg" width="60%">
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/disabled.jpg">
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/orientation.png">
				</section>
				
				<section>
					<h2>Pregnancy</h2>
					<img src="http://intranet.ezrac.com/training/resources/pregnancy.jpg">
				...
				<section>
					...
					<p>treating someone different based on their political affiliation is illegal</p>
					<img src="http://intranet.ezrac.com/training/resources/political.jpeg">
					<p>It's best to keep subjects of political matter out of the workplace</p>
				</section>
				
				<section>
					<h2>Physical Appearance</h2>
					<img src="http://intranet.ezrac.com/training/resources/facialFeatures.jpg">
					<p>What a person looks like.  Hair color facial structure, height, hair type, etc...</p>
				</section>
				
				<section>
					<h2>Veteran / Military Status</h2>
					<img src="http://intranet.ezrac.com/training/resources/veteran.jpg">
				...
				<section>
					...
					<img src="http://intranet.ezrac.com/training/resources/residentAlien.gif">
				...
				<section >
					<h2>Reflection Questions</h2>
					<p style="position: absolute; top: 80%; width: 100%;"><span class="fragment fade-out"><span style="font-size: 2em; color: #ff0000;">Q:</span> If an employee makes fun of another employee's accent, although it's hostile, is it considered illegal harassment?</span></p>
					<p class="fragment fade-in" style="position: absolute; top: 80%; width: 100%;"><span style="font-size: 2em; color: #ff0000;"> A:</span> While making a comment once or twice doesn't add up to legal harassment, it can still be mean or extremely insensitive.  Why wait for the behavior to happen enough times to become "pervasive" illegal harassment before asking someone to stop?
					<br>
					<br>
					A manager should step in right away.
					<br>
					<br>
					Similarly, while one dirty joke won't cross the line into illegal harassment, a one time event that is severe will such as unwanted sexual touching or groping.</p>
				</section>
				...
				<li>The 1991 amendment to Title VII of the Civil Rights Act of 1964 allows victims to recover punitive damages.</li>
					<br>
				<li>Harassment lawsuits usually have personal legal & financial consequences for the harasser.</li>
				</section>
				...
				<br>
				<br>
				<img src="http://intranet.ezrac.com/training/resources/stopHarassment.png" style="border: 5px solid #ffffff; width: 50%;">
				</section>
				
				<!--Managers-->
				<section >
					<h2>Reflection Questions</h2>
					<p style="position: absolute; top: 80%; width: 100%;"><span class="fragment fade-out"><span style="font-size: 2em; color: #ff0000;">Q:</span> If an employee comes to you, upset that a colleague is refusing to let another employee eat lunch with the group because of his religion, what should you do?</span></p>
					<p class="fragment fade-in" style="position: absolute; top: 80%; width: 100%;"><span style="font-size: 2em; color: #ff0000;"> A:</span> As a manager, it's important to encourage your employees to speak up against bullying and harassment.  Keep an open door and let them know you want to hear about any mistreatment or bias.  
					<br>
					<br>Let them know you'll be there to back them up when they step forward to stop what they perceive as bullying or harassing behavior.</p>
				</section>
				
				<!--Managers-->
				<section>
					<h2>Workplace Audits</h2>
					<img src="http://intranet.ezrac.com/training/resources/audit.png" style="float: right; width: 45%;">
					<div style="float: left; width: 45%; font-size: .7em;">
					<p>Managers should regularly audit their workplaces looking for items and behavior that could potentially be harassing.</p><br>
					<p>Ask employees to take home anything that may be offensive or inappropriate for work.</p><br>
					<p>Walk the Talk - model the kind of professional behavior that you want to see in your employees.</p><br>
					</div>
				</section>
				
				<!--Managers-->
				<section>
					<h2>Know the difference between illegal harassment and inappropriate conduct</h2>
					<p>Illegal harassment is pervasive.</p>
					<p>Illegal harassment is severe</p>
					<p>Understand your responsibility as a manager for handling complaints and assisting in investigations and disiplinary action</p>
				</section>
				
				<!--Managers-->
				<section >
					<h2>Reflection Questions</h2>
					<p style="position: absolute; top: 80%; width: 100%;"><span class="fragment fade-out"><span style="font-size: 2em; color: #ff0000;">Q:</span> What if I slip up and say something that offends or unthinkingly tell a questionable joke not realizing my mistake until it's too late?</span></p>
					<p class="fragment fade-in" style="position: absolute; top: 80%; width: 100%;"><span style="font-size: 2em; color: #ff0000;"> A:</span> Again, one joke or remark does not mean that you are harasser and does not meet the threshold of pervasive, ongoing, or severe.  
					<br>
					<br>
					If a colleague or subordinate is offended, acknowledge and apologize for your slip up right away.  This avoids hard feelings.  
					<br><br>
					Going forward,  take care to conduct yourself in a manner that repairs your image and builds trust.</p>
				</section>
				...
				<section>
				<p>How do <span style="font-size: 2em; text-decoration: underline;">we</span> stop disrespectful behavior?</p>
				</section>
				...
				<section>
					...
					<br><br>
					<p>The phone numbers for HR and corporate officers can be found in the phonebook on the E-Z Rent-A-Car intranet site: http://intranet.ezrac.com/</p>
					<br>OR
					<h3>Call (407) 888-0500 and follow the prompt for Human Resources</h3>
				</section>
				
				<!--Managers-->
				<section style="font-size: .8em">
					<h2>Receiving complaints</h2>
					<p>Take all complaints seriously and confidentially, even if you're not sure that the level of harassment reaches legal levels.</p><br>
					<p>Do not ignore any allegation and ensure you respond immeidately</p><br>
					<p>Take the time to ask questions and get accurate details</p><br>
					<p>These details must be sent, in writing, to our HR department: hrgroup@ezrac.com</p><br>
					<p>Ensure no retaliation takes place and ensure you do not engage in any behavior that may be viewed as retaliatory or obstructive to the complaint process.</p><br>
					<p>Document your actions</p><br>
					<p>Have an open door policy</p>
				</section>
				
				<section>
				Care about what you say…<br><br>HOW you say it……………<br><br>Before you say it!!!!
				<img src="http://intranet.ezrac.com/training/resources/speakNoEvil.png">
				</section>
				...
				<br>
				<br>
				<a href="../Quizzes/harassmentMgrExam.php" class="button">Take                   the Exam</a>
				</section>
