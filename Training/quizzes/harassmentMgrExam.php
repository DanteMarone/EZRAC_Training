...
<body>
	...
	<form action="harassmentExamCompleted.php" method="post">
		<div class="submitBtn"><h1>Preventing Harassment Manager Exam</h1></div>
		<div class="question">
		...
		<div class="question">
			<h3>7. I understand that I am expected to act immediately and appropriately if a problem comes to my attention.</h3>
			<input type="radio" name="q7" value="a">True<br>
			<input type="radio" name="q7" value="b">False<br>
		</div>
		
		<div class="question">
			<h3>8. I understand that I may be subject to disciplinary action, up to and possibly including termination, if I engage in unlawful harassment or discrimination myself, or if I fail to meet my supervisory responsibilities to take all reasonable steps to prevent sexual harassment from occuring or if I fail to respond appropriately if a problem arrises.</h3>
