...
<body>
	...
	<div class="wrapper">
		...
		if($score >= 100){
			...
			$sql="INSERT INTO driver_quiz (employeeID, firstname, lastname, date, location)
			...
			<div class=\"question\" style=\"width:800px; height:600px; padding:20px; text-align:center; border: 10px solid #787878; background-image: url('../resources/certificateBG.png'); background-color: #ffffff; background-size: 100%;\">
				<div style=\width:750px; height:550px; padding:20px; text-align:center; border: 5px solid #787878; background-color: #ffffff;\"><br><br><br>
				   ...
				   <span style=\"font-size:45px\">Driver Training</span><br/><br/>
		...
		if($language == "spanish"){
			...
			echo "<br>" . date("m/d/y");
			echo "<br><a href=\"http://intranet/training/quizzes/driverExam_es.php\"><div class=\"button\">De Nuevo al Examen</div></a>";
			echo "<br><a href=\"http://intranet/training/presentations/driver_es.php\"><div class=\"button\">De Nuevo a la Presentation</div></a>";
			echo "</div>";
		}
		...
		//if english
			...
			echo "<br>" . date("m/d/y");
			echo "<br><a href=\"http://intranet/training/quizzes/driverExam.php\"><div class=\"button\">Back to the exam</div></a>";
			echo "<br><a href=\"http://intranet/training/presentations/driver.php\"><div class=\"button\">Back to the presentation</div></a>";
			echo "</div>";
		}
	}
